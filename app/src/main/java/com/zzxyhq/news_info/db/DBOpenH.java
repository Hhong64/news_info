...
public class DBOpenH extends SQLiteOpenHelper {
    /**
     ...
     */
    public DBOpenH(Context context){
        super(context,"db_test",null,1);
        db = getReadableDatabase();
    }
    ...
    public void onCreate(SQLiteDatabase db){
        db.execSQL("CREATE TABLE IF NOT EXISTS user(id INTEGER PRIMARY KEY AUTOINCREMENT,name varchar(20),password varchar(20)," +
                "potrait varchar(100),gender varchar(4))");
    }
    @Override
    ...
    public void updatesex(String sex){
        db.execSQL("UPDATE user SET gender = ?", new String[]{sex});
    }
    ...
    public ArrayList<User> getAllData(){
        ...
        while(cursor.moveToNext()){
            ...
            list.add(new User(name,password,null,null,null,null));
        }
        return list;
    }
    ...
    public User getUserInfo(String userName) {
        ...
        while (cursor.moveToNext()) {
            ...
            user = new User(userName,password,tel,motto,gender,portrait);
        }
        cursor.close();
        return user;
    }
